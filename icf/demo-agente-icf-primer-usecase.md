...
>
> Fuentes: `icf/reunion.txt` (transcripción), `icf/requerimientos-reunion-2026-08-05.md`
> (consolidado R-FIN/R-COM/R-CS/R-PROD), `icf/WhatsApp Audio 2026-08-05 at 12.59.39 PM.html`.
...
- `icf/WhatsApp Audio 2026-08-05 at 12.59.39 PM.html` — transcripción original (audio 40 min).
- `icf/reunion.txt` — misma transcripción en texto plano (fuente de las citas).
- `icf/requerimientos-reunion-2026-08-05.md` — consolidado por rol con códigos R-FIN/R-COM/
