...
- [ent-inexistente-DimTiempoSemana] ~~La entidad 'DimTiempoSemana' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada.~~ **OBSOLETO (2026-08-19): el DBA publicó `DimTiempoSemana`; ya es consultable. No promover este learning — `modulos.md` se actualizó para quitarla de la lista de no disponibles.** (sesión wrun_01M0E4HSM512SF1HQQ56NHBNR9) _(2026-08-19T23:09:08.499Z)_
- [ent-inexistente-InvD] La entidad 'InvD' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada. (sesión wrun_01M0E4PSJATZ60F0BS9B8VRX4Q) _(2026-08-19T23:13:31.042Z)_
- [ent-inexistente-SaldoInv] La entidad 'SaldoInv' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada. (sesión wrun_01M0E4PSJATZ60F0BS9B8VRX4Q) _(2026-08-19T23:13:42.642Z)_
- [ent-inexistente-InvSerieLote] La entidad 'InvSerieLote' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada. (sesión wrun_01M0E4PSJATZ60F0BS9B8VRX4Q) _(2026-08-19T23:13:42.648Z)_
- [ent-inexistente-InvDisp] La entidad 'InvDisp' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada. (sesión wrun_01M0E4PSJATZ60F0BS9B8VRX4Q) _(2026-08-19T23:13:42.654Z)_
- [ent-inexistente-DimTiempoSemanaIso] La entidad 'DimTiempoSemanaIso' NO existe en el MCP de esta empresa (EntityNotFound). Verificar el nombre real en el Company Twin / dab-config. Si un skill la documenta, está desactualizada. (sesión wrun_01M0EA46K9JAXYHENMX8HR2FH5) _(2026-08-20T00:46:57.417Z)_
- [fld-read_records-centrotrabajo] El campo 'CentroTrabajo' no existe en 'read_records' (BadRequest). El casing NO es universal: la mayoría de entidades son camelCase (p.ej. 'FechaEmision' en Compra). Verificar el campo real en erp-kernel/casing.md o con read_records('read_records', first:1) antes de asumir UPPERCASE (solo vistas como ForecastPlanProduccion/UV_QV_PPTOCOMPRA lo son). (sesión wrun_01M0EGHGK31BRQJZX5YSF3XMKA) _(2026-08-20T02:40:09.089Z)_
